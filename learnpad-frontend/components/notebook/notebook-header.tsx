...
export function NotebookHeader({ notebook, canEdit, onChatToggle, isChatView, onOutlineToggle, isOutlineVisible, onEditModeToggle, isEditMode }: NotebookHeaderProps) {
  return (
